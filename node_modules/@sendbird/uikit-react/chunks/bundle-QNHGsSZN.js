import { e as __extends, _ as __assign, a as __spreadArray } from './bundle-DseT8u_-.js';
    ...
    if (rootElement) {
        return (createPortal(React__default.createElement("div", { className: MENU_OBSERVING_CLASS_NAME, id: id },
            ...
            React__default.createElement("ul", { className: "sendbird-dropdown__reaction-bar", "data-testid": "sendbird-dropdown__reaction-bar", ref: reactionRef, style: {
                ...
                ? (React__default.createElement(Label, { className: "sendbird-dropdown__reaction-bar__emptyLabel", type: LabelTypography.BODY_1, color: LabelColors.ONBACKGROUND_1 }, "Emojis is not loaded yet.")) : (React__default.createElement(SortByRow, { className: "sendbird-dropdown__reaction-bar__row", maxItemCount: 8, itemWidth: 44, itemHeight: 40 }, children)))), rootElement));
    }
    return null;
};
...
//# sourceMappingURL=bundle-QNHGsSZN.js.map
