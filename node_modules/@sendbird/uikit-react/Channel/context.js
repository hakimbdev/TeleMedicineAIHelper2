import { _ as __assign, a as __spreadArray } from '../chunks/bundle-DseT8u_-.js';
import React__default, { useEffect, useCallback, useRef, useState, useReducer, useMemo } from 'react';
import { U as UserProfileProvider } from '../chunks/bundle-BCWy1eRp.js';
import { T as ThreadReplySelectType } from '../chunks/bundle-0TrdjZtT.js';
import { m as mergeAndSortMessages, p as passUnsuccessfullMessages, s as scrollIntoLast, d as scrollToRenderedMessage, g as getAllEmojisMapFromEmojiContainer, e as getNicknamesMapFromMembers } from '../chunks/bundle-CDYhXWNX.js';
...
import { K, S } from '../chunks/bundle-DirGjNLX.js';
import { R as RESET_MESSAGES, F as FETCH_INITIAL_MESSAGES_START, a as FETCH_INITIAL_MESSAGES_SUCCESS, b as FETCH_PREV_MESSAGES_SUCCESS, P as PREV_RESULT_SIZE, c as FETCH_NEXT_MESSAGES_SUCCESS, N as NEXT_RESULT_SIZE, d as FETCH_INITIAL_MESSAGES_FAILURE, e as FETCH_PREV_MESSAGES_FAILURE, f as FETCH_NEXT_MESSAGES_FAILURE, S as SEND_MESSAGE_START, g as SEND_MESSAGE_SUCCESS, h as SEND_MESSAGE_FAILURE, i as SET_CURRENT_CHANNEL, j as SET_CHANNEL_INVALID, O as ON_MESSAGE_RECEIVED, k as ON_MESSAGE_UPDATED, l as ON_MESSAGE_THREAD_INFO_UPDATED, m as RESEND_MESSAGE_START, M as MARK_AS_READ, n as ON_MESSAGE_DELETED, o as ON_MESSAGE_DELETED_BY_REQ_ID, p as SET_EMOJI_CONTAINER, q as ON_REACTION_UPDATED, r as MESSAGE_LIST_PARAMS_CHANGED, s as ON_FILE_INFO_UPLOADED, t as ON_TYPING_STATUS_UPDATED, u as useInitialMessagesFetch, v as channelActions } from '../chunks/bundle-BviZJuCc.js';
import { c as compareIds } from '../chunks/bundle-vbkNCu0L.js';
import { l as isSendableMessage, a2 as filterMessageListParams } from '../chunks/bundle-DBSWrD1e.js';
import { u as useLocalization } from '../chunks/bundle-eyKmYzrx.js';
import { GroupChannelHandler } from '@sendbird/chat/groupChannel';
import { u as uuidv4 } from '../chunks/bundle-DTKm24fD.js';
import { u as useSendbird } from '../chunks/bundle-B_GgIa4W.js';
import { u as useReconnectOnIdle } from '../chunks/bundle-d8oeBMu1.js';
import { f as SCROLL_BOTTOM_DELAY_FOR_FETCH, e as SCROLL_BOTTOM_DELAY_FOR_SEND, a as VOICE_MESSAGE_FILE_NAME, b as VOICE_MESSAGE_MIME_TYPE, i as META_ARRAY_VOICE_DURATION_KEY, j as META_ARRAY_MESSAGE_TYPE_KEY, k as META_ARRAY_MESSAGE_TYPE_VALUE__VOICE } from '../chunks/bundle-1qCVlMXW.js';
import { p as pubSubTopics, b as PublishingModuleType, P as PUBSUB_TOPICS, s as shouldPubSubPublishToChannel } from '../chunks/bundle-LBCBjs9d.js';
import { g as getCaseResolvedReplyType, a as getCaseResolvedThreadReplySelectType } from '../chunks/bundle---aixLy5.js';
import { u as useSendMultipleFilesMessage } from '../chunks/bundle-HzWL_k--.js';
