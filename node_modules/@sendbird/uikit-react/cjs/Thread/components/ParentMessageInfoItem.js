...
var index$1 = require('../../chunks/bundle-6nGIhFDY.js');
var tokenize = require('../../chunks/bundle-j9d_a2oN.js');
var useFileInfoListWithUploaded = require('../../chunks/bundle-tO_sLFMv.js');
var MediaQueryContext = require('../../chunks/bundle-DcUoqLZn.js');
var color = require('../../chunks/bundle-DsHHiIba.js');
...
function ParentMessageInfoItem(_a) {
    ...
    var _l = useSendbird.useSendbird().state, stores = _l.stores, config = _l.config, eventHandlers = _l.eventHandlers;
    ...
    var _m = ThreadProvider.useThread(), _o = _m.state, currentChannel = _o.currentChannel, emojiContainer = _o.emojiContainer, nicknamesMap = _o.nicknamesMap, filterEmojiCategoryIds = _o.filterEmojiCategoryIds, toggleReaction = _m.actions.toggleReaction;
