...
var index$1 = require('./bundle-BYZpi6aC.js');
var SendbirdContext = require('./bundle-CrDIwW5W.js');
var utils = require('./bundle-BF92QIXA.js');
var useSendbird = require('./bundle-DVLcUvUT.js');
var getIsReactionEnabled = require('./bundle-D8ZU5Tpa.js');
var resolvedReplyType = require('./bundle-0VXVESR_.js');
var pubSub_topics = require('./bundle-e1RcyXEh.js');
var _const = require('./bundle-FVJAh-zj.js');
var useDeepCompareEffect = require('./bundle-C-CraE0i.js');
var utils$1 = require('./bundle-CWKemlba.js');
var index = require('./bundle-CY1y7JJW.js');
...
function useMessageActions(params) {
    ...
    var _f = useSendbird.useSendbird().state, eventHandlers = _f.eventHandlers, pubSub = _f.config.pubSub;
...
var useGroupChannel = function () {
    var _a, _b, _c;
    var store = React.useContext(GroupChannelContext);
    if (!store)
    ...
    var setAnimatedMessageId = React.useCallback(function (messageId) {
        store.setState(function (state) { return (_tslib.__assign(_tslib.__assign({}, state), { animatedMessageId: messageId })); });
    }, []);
    var setIsScrollBottomReached = React.useCallback(function (isReached) {
        store.setState(function (state) { return (_tslib.__assign(_tslib.__assign({}, state), { isScrollBottomReached: isReached })); });
    }, []);
    var scrollToBottom = React.useCallback(function (animated) { return _tslib.__awaiter(void 0, void 0, void 0, function () {
        return _tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var scrollToMessage = React.useCallback(function (createdAt, messageId, messageFocusAnimated, scrollAnimated) { return _tslib.__awaiter(void 0, void 0, void 0, function () {
    ...
    var toggleReaction = React.useCallback(function (message, emojiKey, isReacted) {
    ...
    var messageActions = useMessageActions(_tslib.__assign(_tslib.__assign({}, state), { scrollToBottom: scrollToBottom }));
    var setCurrentChannel = React.useCallback(function (channel) {
        store.setState(function (state) { return (_tslib.__assign(_tslib.__assign({}, state), { currentChannel: channel, fetchChannelError: null, quoteMessage: null, animatedMessageId: null, nicknamesMap: new Map(channel.members.map(function (_a) {
                var userId = _a.userId, nickname = _a.nickname;
                return [userId, nickname];
            })) })); }, true);
    }, []);
    var handleChannelError = React.useCallback(function (error) {
        store.setState(function (state) { return (_tslib.__assign(_tslib.__assign({}, state), { currentChannel: null, fetchChannelError: error, quoteMessage: null, animatedMessageId: null })); });
    }, []);
    var setQuoteMessage = React.useCallback(function (message) {
        store.setState(function (state) { return (_tslib.__assign(_tslib.__assign({}, state), { quoteMessage: message })); });
    }, []);
    var actions = React.useMemo(function () {
        return _tslib.__assign({ setCurrentChannel: setCurrentChannel, handleChannelError: handleChannelError, setQuoteMessage: setQuoteMessage, scrollToBottom: scrollToBottom, scrollToMessage: scrollToMessage, toggleReaction: toggleReaction, setAnimatedMessageId: setAnimatedMessageId, setIsScrollBottomReached: setIsScrollBottomReached }, messageActions);
    }, [
        setCurrentChannel,
        handleChannelError,
        setQuoteMessage,
...
function useMessageListScroll(behavior, deps) {
    ...
    var scrollPubSub = React.useState(function () { return index$1.pubSubFactory({ publishSynchronous: true }); })[0];
...
var initialState = {
    ...
    showSearchIcon: true,
    replyType: 'NONE',
    threadReplySelectType: _const.ThreadReplySelectType.PARENT,
    disableMarkAsRead: false,
    scrollBehavior: 'auto',
    scrollPubSub: null,
};
var GroupChannelContext = React.createContext(null);
var createGroupChannelStore = function (props) { return SendbirdContext.createStore(_tslib.__assign(_tslib.__assign({}, initialState), props)); };
var InternalGroupChannelProvider = function (props) {
    var children = props.children;
    var defaultProps = utils$1.deleteNullish({
    ...
    var storeRef = React.useRef(createGroupChannelStore(defaultProps));
    return (React__default.default.createElement(GroupChannelContext.Provider, { value: storeRef.current }, children));
};
var GroupChannelManager = function (props) {
    ...
    var _h = useSendbird.useSendbird().state, config = _h.config, stores = _h.stores;
    ...
    var resolvedReplyType$1 = resolvedReplyType.getCaseResolvedReplyType(moduleReplyType !== null && moduleReplyType !== void 0 ? moduleReplyType : config.groupChannel.replyType).upperCase;
    var resolvedThreadReplySelectType = resolvedReplyType.getCaseResolvedThreadReplySelectType(moduleThreadReplySelectType !== null && moduleThreadReplySelectType !== void 0 ? moduleThreadReplySelectType : config.groupChannel.threadReplySelectType).upperCase;
    ...
    var resolvedIsReactionEnabled = getIsReactionEnabled.getIsReactionEnabled({
    ...
    var messageDataSource = uikitTools.useGroupChannelMessages(sdkStore.sdk, state.currentChannel, {
    ...
    uikitTools.useAsyncLayoutEffect(function () { return _tslib.__awaiter(void 0, void 0, void 0, function () {
        ...
        return _tslib.__generator(this, function (_a) {
            ...
            if ((pubSub === null || pubSub === void 0 ? void 0 : pubSub.subscribe) === undefined)
                return [2 /*return*/];
            subscriptions = [
                config.pubSub.subscribe(pubSub_topics.pubSubTopics.SEND_USER_MESSAGE, handleExternalMessage),
                config.pubSub.subscribe(pubSub_topics.pubSubTopics.SEND_FILE_MESSAGE, handleExternalMessage),
            ];
    ...
    var renderProps = React.useMemo(function () { return ({
    ...
    var scrollState = React.useMemo(function () { return ({
        scrollRef: scrollRef,
        scrollPubSub: scrollPubSub,
        scrollDistanceFromBottomRef: scrollDistanceFromBottomRef,
        scrollPositionRef: scrollPositionRef,
    ...
    useDeepCompareEffect.useDeepCompareEffect(function () {
        updateState(_tslib.__assign(_tslib.__assign(_tslib.__assign(_tslib.__assign(_tslib.__assign({ 
            // Channel state
...
var GroupChannelProvider = function (props) {
    return (React__default.default.createElement(InternalGroupChannelProvider, _tslib.__assign({}, props),
        React__default.default.createElement(GroupChannelManager, _tslib.__assign({}, props),
            React__default.default.createElement(UserProfileContext.UserProfileProvider, _tslib.__assign({}, props), props.children))));
};
/**
...
var useGroupChannelStore = function () {
    return SendbirdContext.useStore(GroupChannelContext, function (state) { return state; }, initialState);
};
...
exports.GroupChannelManager = GroupChannelManager;
exports.GroupChannelProvider = GroupChannelProvider;
exports.InternalGroupChannelProvider = InternalGroupChannelProvider;
exports.useGroupChannel = useGroupChannel;
exports.useGroupChannelContext = useGroupChannelContext;
//# sourceMappingURL=bundle-1RtlcY_X.js.map
