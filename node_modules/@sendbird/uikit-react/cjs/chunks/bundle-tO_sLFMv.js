...
function MultipleFilesMessageItemBody(_a) {
    var _this = this;
    var className = _a.className, message$1 = _a.message, _b = _a.isReactionEnabled, isReactionEnabled = _b === void 0 ? false : _b, threadMessageKindKey = _a.threadMessageKindKey, _c = _a.statefulFileInfoList, statefulFileInfoList = _c === void 0 ? [] : _c, _d = _a.onBeforeDownloadFileMessage, onBeforeDownloadFileMessage = _d === void 0 ? null : _d;
    var logger = useSendbird.useSendbird().state.config.logger;
    var _e = React.useState(-1), currentFileViewerIndex = _e[0], setCurrentFileViewerIndex = _e[1];
    function onClose() {
...
//# sourceMappingURL=bundle-tO_sLFMv.js.map
