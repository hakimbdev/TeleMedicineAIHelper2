 ...
 */
var createSendbirdContextStore = function (props) { return createStore({
    config: _tslib.__assign(_tslib.__assign({}, initialState.config), props === null || props === void 0 ? void 0 : props.config),
    stores: _tslib.__assign(_tslib.__assign({}, initialState.stores), props === null || props === void 0 ? void 0 : props.stores),
    eventHandlers: _tslib.__assign(_tslib.__assign({}, initialState.eventHandlers), props === null || props === void 0 ? void 0 : props.eventHandlers),
    emojiManager: initialState.emojiManager,
    utils: _tslib.__assign(_tslib.__assign({}, initialState.utils), props === null || props === void 0 ? void 0 : props.utils),
}); };
/**
