...
var index$1 = require('./bundle-BfwsoZ_f.js');
var useReconnectOnIdle = require('./bundle-DfxuJbi-.js');
...
function channelListReducer(state, action) {
    return (index.K(action)
        ...
        if (channelListQuery) {
            ...
            if (index$1.isChannelJustCreated(channel)) {
                return state;
            }
...
var ChannelListContext = React__default.default.createContext(null);
/**
...
//# sourceMappingURL=bundle-D7a7lRhc.js.map
